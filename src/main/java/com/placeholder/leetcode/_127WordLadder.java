...
public class _127WordLadder {
    ...
    @Test
    public void test() {
        // Assert.assertEquals(true, isNextWord("hit", "hot"));
        // Assert.assertEquals(true, isNextWord("hot", "dot"));
        // Assert.assertEquals(false, isNextWord("hit", "hhh"));
        Assert.assertEquals(5, dijkstraLadderLength("hit", "cog", new HashSet<>(Arrays.asList("hot", "dot", "dog", "lot", "log"))));
